...
<html lang="fr">
    ...
    <body>
        ...
        <a href="planning.php"  style="color: black;font-size: 25px;text-decoration: none;">Planning</a>
        <a href="reservation-form.php" style="color: black;font-size: 25px;text-decoration: none;">Réservation</a>        
